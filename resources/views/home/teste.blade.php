...
<head>
    ...
    .logo-brasil-japao img {
        height: 120px;       /* aumente o tamanho conforme desejar */
        max-height: 120px;
    }    
    </style>
</head>
        ...
        <div class="container">
            <div class="navbar-logos-wrapper">
                <div class="navbar-logos">
                    ...
                    <a class="navbar-brand logo-brasil-japao" href="/">
                        <img src="/assets/img/brasil_japao.png" alt="Brasil & Japão">
                    </a>
                    
                    <a class="navbar-brand" href="https://www.gov.br/cultura/pt-br/assuntos/lei-paulo-gustavo" target="_blank">
                        <img src="/assets/images/horizontal_preferencial.png" alt="Lei Paulo Gustavo">
                    </a>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 mb-4 mb-lg-0">
                    <div class="about-image">
                        <img src="/assets/images/speakers/featured-speaker.jpg" alt="EXPOASA">
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="about-content">
                        ...
                        <p>A EXPOASA – Exposição Regional de Assaí é um evento voltado para o agronegócio,
                           sendo a sua primeira edição realizada no ano de 1935. Esta exposição é
                           considerada a mais antiga da América Latina, surgindo do esforço dos primeiros
                           imigrantes japoneses, que colonizaram a região de Assaí em 1930.</p>
                        
                        <p>Durante todos os anos de realização, a EXPOASA movimentou milhares de pessoas, reunindo
                           um público de mais de 26 cidades, tornando-se parte da cultura de Assaí e região. A exposição é 
                           rica em atrações culturais, trazendo o Bon Odori, Taikô, Ikebana, Matsuri Dance e o Cosplay.</p>
                        
                        <div class="mt-4">
                            <a href="{{ route('ideasun.index') }}" class="btn btn-primary">Faça sua Inscrição | IDEASUN</a>
                            <a href="/upload/Conheca_Historia.pdf" target="_blank" class="btn btn-outline ml-3">Saiba Mais</a>
                        </div>
                    </div>
                </div>
            </div>
...
{{-- 
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="arena-card">
                        <div class="arena-image">
                            <img src="/assets/images/arenas/bg_arenagastronomica.jpg" alt="Arena Gastronômica">
                            <div class="arena-overlay">
                                <i class="fa fa-search-plus fa-2x"></i>
                            </div>
                        </div>
                        <div class="arena-content">
                            <h3>Arena Gastronômica</h3>
                            <p>Delícias da culinária japonesa e internacional para todos os gostos.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="arena-card">
                        <div class="arena-image">
                            <img src="/assets/images/arenas/bg_arenacultura.jpg" alt="Arena Cultural">
                            <div class="arena-overlay">
                                <i class="fa fa-search-plus fa-2x"></i>
                            </div>
                        </div>
                        <div class="arena-content">
                            ...
                            <p>Apresentações de Taikô, Bon Odori, Matsuri Dance e manifestações culturais.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="arena-card">
                        <div class="arena-image">
                            <img src="/assets/images/arenas/tenda_conhecimento.jpg" alt="Tenda do Conhecimento">
                            <div class="arena-overlay">
                                <i class="fa fa-search-plus fa-2x"></i>
                            </div>
                        </div>
                        <div class="arena-content">
                            ...
                            <p>Palestras, workshops e seminários sobre inovação, agronegócio e sustentabilidade.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="arena-card">
                        <div class="arena-image">
                            <img src="/assets/images/arenas/expositores.jpg" alt="Arena de Expositores">
                            <div class="arena-overlay">
                                <i class="fa fa-search-plus fa-2x"></i>
                            </div>
                        </div>
                        <div class="arena-content">
                            <h3>Arena de Expositores</h3>
                            <p>Produtos, serviços e tecnologias das principais empresas e produtores da região.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section bg-light">
        <div class="container">
            <div class="section-title">
                <h2>Programação <span class="accent">Técnica</span></h2>
                <p>Veja a programação da Arena do Conhecimento</p>
            </div>
            ...
            <div class="schedule-content">
                <!-- Dia 1 -->
                <div class="schedule-day active" id="day-1">
                    ...
                    <div class="schedule-row" style="background-color: #f8d7da;">
                        <div class="time-block"><strong>MANHÃ</strong></div>
                    ...
                    <div class="schedule-row">
                        ...
                        <div class="speaker-block">
                            <img src="/assets/images/speakers/speaker_thumb_grazielle.jpg" alt="Grazielle Furtado">
                            <span>Grazielle Furtado</span>
                        </div>
                        <div>Manejo Integrado de Pragas do Abacateiro</div>
                    </div>
                    
                    <div class="schedule-row" style="background-color: #f8d7da;">
                        <div class="time-block"><strong>TARDE</strong></div>
                        <div class="speaker-block"></div>
                        <div></div>
                    </div>
                ...
                <!-- Dia 2 e 3 com estrutura similar -->
                <div class="schedule-day" id="day-2" style="display: none;">
                    <!-- Conteúdo para o dia 2 -->
                </div>
                
                <div class="schedule-day" id="day-3" style="display: none;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <h2 class="text-white mb-4">Destaques do Evento</h2>
                    ...
                    <div class="feature-grid">
                        ...
                        <div class="feature-item">
                            ...
                            <h3>Seminários & Oficinas</h3>
                        </div>
                        
                        <div class="feature-item">
                            <i class="fa fa-calendar"></i>
                            <h3>3 dias de evento</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="registration-content">
                        ...
                        <p>NA MARATONA DE INOVAÇÃO - IDEASUN</p>
                        
                        <a href="{{ route('ideasun') }}" class="btn btn-light">
                            <i class="fa fa-ticket mr-2"></i>Faça sua Inscrição
                        </a>
    ...
    <section class="section">
        <div class="container">
            <div class="section-title">
                <h2>Projetos <span class="accent">Especiais</span></h2>
                <p>Conheça as iniciativas que estão transformando nossa comunidade</p>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="project-card">
                        <div class="project-image">
                            <img src="/assets/images/projects/omoide.jpg" alt="Projeto Omoide">
                        </div>
                        <div class="project-content">
                            <h3>Projeto OMOIDE</h3>
                            <p>Registre seu depoimento sobre a importância da cultura japonesa para o desenvolvimento do Brasil.</p>
                ...
                <div class="col-md-4">
                    <div class="project-card">
                        <div class="project-image">
                            <img src="/assets/images/projects/jornal.jpg" alt="Jornal Asahi">
                        </div>
                        <div class="project-content">
                            <h3>Jornal Asahi</h3>
                            <p>Jornal municipal administrado por estudantes do ensino médio e fundamental da cidade de Assaí, focado em notícias.</p>
                            <div class="project-actions">
                                <a href="https://www.jornalasahi.com.br/" target="_blank" class="btn btn-primary btn-sm">Conheça</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="section bg-light">
        <div class="container">
            <div class="section-title">
                <h2>Nossos <span class="accent">Apoiadores</span></h2>
            ...
            <div class="sponsor-category">
                ...
                <div class="sponsor-grid">
                    <div class="sponsor-item">
                        <img src="/assets/images/sponsors/sponsor-vds1.png" alt="Vale do Sol">
                    </div>
                    
                    <div class="sponsor-item">
                        <img src="/assets/images/sponsors/sponsor-prefeitura.png" alt="Prefeitura Municipal de Assaí">
                    </div>
            ...
            <!-- Outras categorias de patrocinadores podem ser adicionadas aqui -->
        </div>
    </section>
    ...
    <section class="map-section">
        ...
        <div class="map-overlay">
            ...
            <div class="address-item">
                ...
                <span>Avenida Paul Harris, S/N, Assaí, Paraná, Brasil<br>CEP 86220-000</span>
            </div>
            
            <div class="address-item">
                <i class="fa fa-phone"></i>
                <span>(43) 3262-8306</span>
            </div>
            
            <a href="https://maps.app.goo.gl/VMiKEB5NxdVM8ni6A" target="_blank" class="btn btn-light mt-3">Como Chegar</a>
        </div>
    </section>
