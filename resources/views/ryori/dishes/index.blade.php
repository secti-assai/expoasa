...
@section('content')
    <section class="hero-section">
        <div class="container">
            ...
            <p class="lead mb-0">Conheça os deliciosos pratos que estão competindo no RYORI 2025</p>
        </div>
    </section>
            ...
            <div class="col-md-6 col-lg-4 mb-4 dish-item">
                <div class="card card-ryori dish-card h-100">
                    <div class="position-relative overflow-hidden">
                        @if($dish->image_path)
                            <img src="{{ $dish->image_path }}" class="card-img-top dish-image" alt="{{ $dish->name }}">
                        @else
                            <img src="/assets/img/dish-placeholder.jpg" class="card-img-top dish-image" alt="{{ $dish->name }}">
                        @endif
